...
begin
	...
	@bind iter Slider(1:niter, default=1)
...
begin
	...
	plot!(x, d_all[:, iter], subplot=2, title="d (Iter $iter)")
	plot!(x, H_all[:, iter], subplot=3, title="H (Iter $iter)")
